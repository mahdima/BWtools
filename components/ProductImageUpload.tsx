...
export const ProductImageUpload = ({ defaultValue, name = "productImage" }: ProductImageUploadProps) => {
    const [preview, setPreview] = useState<string | null>(defaultValue || null);
    const [existingUrl, setExistingUrl] = useState<string | null>(defaultValue || null);
        ...
        <div className="w-full flex flex-col items-center">
            <div className="w-full h-[300px] rounded-lg mb-4 overflow-hidden bg-gray-100 flex items-center justify-center border-2 border-dashed border-gray-300 relative group">
                {preview ? (
                    ...
                    <div className="text-gray-400 flex flex-col items-center cursor-pointer" onClick={handleTriggerClick}>
                ...
                <input type="hidden" name="existingImageUrl" value={existingUrl || ""} />
            </div>
