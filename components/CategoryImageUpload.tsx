...
export const CategoryImageUpload = ({ defaultValue, name = "categoryImage" }: CategoryImageUploadProps) => {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            <div className="w-full h-[300px] rounded-lg mb-4 overflow-hidden bg-gray-100 flex items-center justify-center border-2 border-dashed border-gray-300 relative group">
                ...
                {/* Hidden input to store existing URL if no new file is selected */}
                {defaultValue && (
